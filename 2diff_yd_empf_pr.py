...
def main(conf_dir, env_tag, before_dir, after_dir, odir1_tag, time_tag):
    ...
    arg1 = os.path.join(input_dir, env_tag, before_dir + time_tag, odir1_tag) #yesterday
    arg2 = os.path.join(input_dir, env_tag, after_dir + time_tag, odir1_tag) #today
...
if __name__ == "__main__":
    ...
    odir1_tag = "prne_conf"
    time_tag = "_0430"
    main(conf_dir, env_tag, yesterday, today, odir1_tag, time_tag)
    #####################################
    env_tag = "empf_pr"
    odir1_tag = "prne_hw"
    time_tag = "_0430"
